    ...
    <div className="about">
      <div className="container">
        <div className="section-title">
          <h2>About Marine Technologies Solutions</h2>
        </div>
        ...
        <div className="row">
          <div className="col-2">
            <div className="about-content">
              <h3>Our Story</h3>
              <p>
                Founded in 2024, Marine Technologies Solutions has been at the
                forefront of digital innovation for over a decade. What started
                as a small team of passionate developers has grown into a
                comprehensive technology partner for businesses across
                industries worldwide.
              </p>
              <p>
                Over the years, we've helped hundreds of companies transform
                their digital presence, streamline operations, and create
              ...
              <div className="about-vision">
                <h3>Our Vision</h3>
                <p>
                  To be the catalyst for technological advancement, empowering
                  businesses to thrive in the digital age through innovative
              ...
              <div className="about-mission">
                <h3>Our Mission</h3>
                <p>
                  We deliver cutting-edge technology solutions that solve
                  complex business challenges, drive digital transformation, and
              ...
              <div className="values-grid">
                ...
                <div className="value-item">
                  ...
                  <div className="value-content">
                    <h4>Excellence</h4>
                    <p>
                      We commit to delivering exceptional quality in everything
                      we do.
                    </p>
                  </div>
                </div>
